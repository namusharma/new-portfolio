...
export function Room(props) {
  ...
  color: "#e5e7ea", // soft white sheer curtain, matches the window side in the reference
});

const bodyMaterial = new THREE.MeshPhongMaterial({
  color: "#a9adb3", // light warm-grey wall
  shininess: 10,
});

const tableMaterial = new THREE.MeshPhongMaterial({
  color: "#f4f4f2", // clean white desk surface
});

const radiatorMaterial = new THREE.MeshPhongMaterial({
  color: "#ffffff", // white, matches desk/drawer unit
});

const compMaterial = new THREE.MeshStandardMaterial({
  color: "#1c1d1f", // matte black tower/speaker tone
});

const pillowMaterial = new THREE.MeshPhongMaterial({
  color: "#3ec6f0", // vivid cyan-blue, matching the LED strip accent
});

const chairMaterial = new THREE.MeshPhongMaterial({
  color: "#1a1a1c", // black ergonomic chair
});
  return (
